<table width="100%" height="100%"  class="tabletr">
	<tr >
		<td>
			...
			?>
             <div id="form">
					<form action="http://atd.adwmicro.pl/index.php" method="post"> 
						<input type="text" name="imienazwisko" style="width:90%;" placeholder="<?php echo $lang['name']; ?>"><br />
						<input type="text" name="email" style="width:44%" placeholder="E-Mail">
						<input type="text" name="telefon" style="width:44%" placeholder="Telefon."><br />

						<input type="text" name="trescwiadomosci"  style="width:90%"placeholder="<?php echo $lang['massage']; ?>"><br/>
	...
	<tr >
		<td>
			<table class=tabledwa >
				<tr>
					<td>
						<a href="http://atd.adwmicro.pl"><img src="img/section-conto-img/twit.png" ></a>
						<a href="http://atd.adwmicro.pl"><img src="img/section-conto-img/face.png" ></a>
						<a href="http://atd.adwmicro.pl"><img src="img/section-conto-img/gog.png" ></a>
						<a href="http://atd.adwmicro.pl"><img src="img/section-conto-img/skype.png" ></a>
					</td>
				</tr>
			</table>
			</td>
