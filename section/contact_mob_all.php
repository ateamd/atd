...
<table width="100%" height="500px" class="tabletrtel">
    <tr>
        <td>
             <?php
             ...
             ?>
                <div id="form">
                    <form action="http://adwmicro.pl/index.php" method="post">
                        ...
                        <input type="text" class="text_box_form" name="email" style="width:90%" placeholder="E-Mail"><br>
                        ...
                        <input type="submit" name="submit" class="buttonstel" value=<?php echo $lang['send']; ?>>
