...
<ul class="jen">
    ...
    <li id="eng" ><a href="?lang=ang">ENG</li>
</ul>
    ...
    <div class="center">
            ...
            <li id="cs"><a href="javascript:jumpScroll1()"><?php echo $lang['contact']; ?></a></li>
            <li id="ct"><a href="javascript:jumpScroll2()"><?php echo $lang['clients']; ?></a></li>
        </ul>
